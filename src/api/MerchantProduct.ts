...
// 獲取列表
export function GetProductData (page: string, path = user) {
...
export function DeletProduct (id: string, path = user) {
  return service.request({
    method: 'delete',
    headers,
...
export function AddPouduct (data: Product, path = user) {
  return service.request({
    method: 'post',
    headers,
...
export function EditPouduct (data: Product, path = user) {
  return service.request({
    method: 'put',
    headers,
